...
import com.imengyu.datacenter.exception.ConstraintViolationExceptionResponseEntity;
import com.imengyu.datacenter.exception.ErrorResponseEntity;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ErrorResponseEntity constraintViolationExceptionHandler(HttpServletRequest request, final Exception e, HttpServletResponse response) {
        ...
        return new ConstraintViolationExceptionResponseEntity(HttpStatus.BAD_REQUEST.value(), "请求参数验证失败", exception.getMessage());
    }
    ...
    public ErrorResponseEntity fileNotFoundExceptionHandler(HttpServletRequest request, final Exception e, HttpServletResponse response) {
        ...
        return new ConstraintViolationExceptionResponseEntity(HttpStatus.NOT_FOUND.value(), "未找到指定文件", exception.getMessage());
    }
